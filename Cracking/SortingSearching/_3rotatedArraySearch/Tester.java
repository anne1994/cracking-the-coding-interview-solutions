...
public class Tester {
	...
	private static void test(int[] rotatedArray, int num) {
		//System.out.println("rotated array len" + (rotatedArray.length));
		System.out.format("%n%2d is at index: %2d", num,rotatedSearch.search(rotatedArray, 0, rotatedArray.length-1, num));
	}
}